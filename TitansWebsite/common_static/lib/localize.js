        ...
        this.$get = ['$http', '$rootScope', '$window', '$filter', function ($http, $rootScope, $window, $filter) {
            ...
            var localize = {
                ...
                buildUrl: function(baseUrl) {
                    if(!localize.language){
                        ...
                        if ($window.navigator && $window.navigator.userAgent &&
                            (androidLang = $window.navigator.userAgent.match(/android.*\W(\w\w)-(\w\w)\W/i))) {
                            lang = androidLang[1];
                        } else {
                ...
                initLocalizedResources:function () {
                    ...
                    $http({ method:"GET", url:url, cache:false }).then(localize.successCallback, function () {
